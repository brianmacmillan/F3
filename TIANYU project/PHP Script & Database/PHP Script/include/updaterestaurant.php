                                    ...
                                    <div class="col-lg-12 col-sm-9">
                                        <select class="form-control boder" id="browsers" name="foodcat[]" title="Please select at least one Category"
                                            ...
                                            while($re=mysqli_fetch_array($qury)){
                                                $ry=mysqli_query($con,"select * from tbl_food WHERE food_id='$dataid' && food_type='".$re['name']."' ");
                                                $ddt=mysqli_fetch_array($ry);
                                                if($ddt) {?><option  value="<?php echo $re['name']; ?>" selected><?php echo $re['name']; ?></option><?php }  else {
                                                    ?><option  value="<?php echo $re['name']; ?>" ><?php echo $re['name']; ?></option><?php } ?>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>
