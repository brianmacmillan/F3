    ...
    <div class="modal-body">
        ...
        <div class="row" style="color: black;">
            <div class="col-lg-8 form-group">
                ...
                <input type="text" value="" style="color: #62A8EA;" class="form-control" name="cat" placeholder="Enter Category Name" required="">
            </div>
            <div class="col-lg-8 form-group">
        ...
        <div class="modal-footer">
            <button class="btn btn-primary" name="addcat" type="submit" >Add Category</button>
        </div>
        <?php }
        else{
            ?>
            <div class="modal-footer">
                <button class="btn btn-primary" onclick="rightadd()" type="button" >Add Category</button>
            </div>
            <?php
        }?>
